...
typedef struct {
    ...
    */
    ...
    uint16_t            NRF_SCK_PIN;
    GPIO_TypeDef*       NRF_SCK_GPIOx;

    uint16_t            NRF_MOSI_PIN;
    GPIO_TypeDef*       NRF_MOSI_GPIOx;

    uint16_t            NRF_MISO_PIN;
    GPIO_TypeDef*       NRF_MISO_GPIOx;
